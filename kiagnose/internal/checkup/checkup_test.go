...
func TestCheckupWith(t *testing.T) {
	...
	for _, testCase := range checkupCreateTestCases {
		t.Run(testCase.description, func(t *testing.T) {
			...
			resultsConfigMapName := checkup.NameResultsConfigMap(checkupName)
			resultsConfigMapWriterRoleName := checkup.NameResultsConfigMapWriterRole(checkupName)
			serviceAccountName := checkup.NameServiceAccount(checkupName)
...
func TestCheckupRunShouldCreateAJob(t *testing.T) {
	...
	for _, testCase := range checkupRunTestCases {
		...
		t.Run(testCase.description, func(t *testing.T) {
			...
			expectedResultsConfigMapName := checkup.NameResultsConfigMap(checkupName)
