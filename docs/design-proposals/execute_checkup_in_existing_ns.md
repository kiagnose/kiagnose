...
The suggested solution is to create user-supplied [ConfigMap](https://kubernetes.io/docs/concepts/configuration/configmap/) objects in the namespace in which the checkup shall be executed.
...
Kiagnose should be given “delete” permissions of the following objects:
